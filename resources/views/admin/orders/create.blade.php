                      ...
                      <form class="form-inline">
                        <div class="col-md-12">
                            <div class="form-group ">
                                ...
                                <input type="text" value="" disabled="" style="background-color: #ced4da" class="my-form-control" 
                        ...
                        <div class="col-md-12">
                            <div class="form-group ">
                                ...
                                <input type="number" value="" onchange="setDecorationPrice(this);"
                                onkeyup="setDecorationPrice(this);"   name="pl_s_xl" class="my-form-control" id="pl_s_xl" placeholder="">
                                ...
                                onkeyup="getDecorationPrice(this);" name="color_location1" max="8" min="1" class="my-form-control" id="color_location1" placeholder="">
                            </div>
                            <div class="form-group ">
                                <label for="pl_xxl" class="col-sm-3 col-form-label font-weight-600">XXL</label>
                                <input type="number" value="" class="my-form-control" name="pl_xxl" class="my-form-control" id="pl_xxl" onchange="setDecorationPrice(this);"
                                ...
                                <input type="number" value="" onchange="getDecorationPrice(this);"
                                onkeyup="getDecorationPrice(this);" class="my-form-control" name="color_location2" max="8" min="1" class="my-form-control" id="color_location2" placeholder="">
                            </div>
                            <div class="form-group ">
                                <label for="pl_xxxl" class="col-sm-3 col-form-label font-weight-600">XXXL</label>
                                <input type="number" value="" class="my-form-control" name="pl_xxxl" class="my-form-control" id="pl_xxxl" onchange="setDecorationPrice(this);"
                                onkeyup="setDecorationPrice(this);" placeholder="">
                                <label for="color_location3" class="col-sm-3 col-form-label font-weight-600"># of Colors Location 3</label>
                                <input type="number" value=""onchange="getDecorationPrice(this);"
                                onkeyup="getDecorationPrice(this);" class="my-form-control" name="color_location3" max="8" min="1" class="my-form-control" id="color_location3" placeholder="">
                            </div>
                            <div class="form-group ">
                                <label for="pl_xxxxl" class="col-sm-3 col-form-label font-weight-600">XXXXL</label>
                                <input type="number" value="" class="my-form-control" name="pl_xxxxl" class="my-form-control" id="pl_xxxxl" onchange="setDecorationPrice(this);"
                                onkeyup="setDecorationPrice(this);" placeholder="">
                                <label for="color_location4" class="col-sm-3 col-form-label font-weight-600"># of Colors Location 4</label>
                                <input type="number" value=""  class="my-form-control" name="color_location4" max="8" min="1" class="my-form-control" onchange="getDecorationPrice(this);"
                            ...
                            <div class="form-group ">
                                ...
                                <input type="number" value="" class="my-form-control" name="pl_xxxxxl" class="my-form-control" id="pl_xxxxxl" onchange="setDecorationPrice(this);"
                                onkeyup="setDecorationPrice(this);" placeholder="">
                                <label for="color_location5" class="col-sm-3 col-form-label font-weight-600"># of Colors Location 5</label>
                                <input type="number" value="" onchange="getDecorationPrice(this);"
                                onkeyup="getDecorationPrice(this);" class="my-form-control" name="color_location5" max="8" min="1" class="my-form-control" id="color_location5" placeholder="">
                            </div>
                        </div>
                    </form>
                </div>
                   ...
                   <form class="form-inline offset-md-2">
                       <div class="col-md-12 mt-2">
                        <div class="form-group row">
                            ...
                            <input type="number" min="0" name="location1_charge" value="" class="form-control location_charges" id="location1_charge" placeholder="">
                    ...
                    <div class="col-md-12 mt-2">
                        <div class="form-group row">
                            ...
                            <input type="number" min="0" name="location2_charge" value="" class="form-control location_charges" id="location2_charge" placeholder="">
                    ...
                    <div class="col-md-12 mt-2">
                        <div class="form-group row">
                            ...
                            <input type="number" min="0" name="location3_charge" value="" class="form-control location_charges" id="location3_charge" placeholder="">
                    ...
                    <div class="col-md-12 mt-2">
                        <div class="form-group row">
                            ...
                            <input type="number" min="0" name="location4_charge" value="" class="form-control location_charges" id="location4_charge" placeholder="">
                    ...
                    <div class="col-md-12 mt-2">
                        <div class="form-group row">
                            ...
                            <input type="number" min="0" name="location5_charge" value="" class="form-control location_charges" id="location5_charge" placeholder="">
...
<script>
    $(document).ready(function(){
        ...
        $(document).on('click', '#add_product', function(event) {
            event.preventDefault();
            var time = {{time()}};
// var product_add         = $(this).parent().next().find(".cloneDev").first().clone();
...
// new_product_add.find('input[type=checkbox]').attr('checked', false);
console.log(new_product_add);
