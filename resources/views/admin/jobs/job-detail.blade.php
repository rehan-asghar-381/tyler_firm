            ...
            <div class="card mb-4">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="fs-17 font-weight-600 mb-0">Task Info</h6>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="#!" class="fs-13 font-weight-600">{{ $job_detail->Status->name }}</a>
                        </div>
                    </div> 
                    <hr>
                    <div class="row align-items-center">
                        <div class="col">
                            <h6 class="mb-0 font-weight-600">Order ID</h6>
                        </div>
                        <div class="col-auto">
                            <a href="#!" class="fs-13 font-weight-600">{{ $job_detail->order_id }}</a>
                        </div>
                    </div> 
                    <hr>
                    <div class="row align-items-center">
                        <div class="col">
                            <h6 class="mb-0 font-weight-600">Tailor Name</h6>
                        </div>
                        <div class="col-auto">
                            <a href="#!" class="fs-13 font-weight-600">{{ $job_detail->User->name }}</a>
                        </div>
                    </div>
                    <hr>
                    <div class="row align-items-center">
                        <div class="col">
                            <h6 class="mb-0 font-weight-600">Start Date</h6>
                        </div>
                        <div class="col-auto">
                            <a href="#!" class="fs-13 font-weight-600">{{ $job_detail->start_date_time }}</a>
                        </div>
                    </div>
                    <hr>
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="#!" class="fs-13 font-weight-600">{{ $job_detail->notes }}</a>
                        </div>
                    </div>
                    <hr>
                    <div class="row align-items-center">
                        <div class="col">
                            <h6 class="mb-0 font-weight-600">Completion Date</h6>
                        </div>
                        <div class="col-auto">
                            <a href="#!" class="fs-13 font-weight-600">{{ $job_detail->completion_date_time }}</a>
                        </div>
                    </div>
                    <hr>
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <span class="fs-13 font-weight-600 text-muted">{{ $job_detail->assigend_by_name }}</span>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            <h6 class="mb-0 font-weight-600">Current Status</h6>
                            @php
                                $current_status         = '';
                                if($job_detail->status == 0){

                                    $current_status =  "Pending";
                                }elseif($job_detail->status == 1){
                        ...
                        <div class="col-auto">
                            <a href="#!" class="fs-13 font-weight-600">{{ $current_status }}</a>
                        </div>
                    </div>
                </div>
            </div>
