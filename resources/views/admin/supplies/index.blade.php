			...
			<div class="card mb-4">
				<div class="card-header">
					<div class="d-flex justify-content-between align-items-center">
						<div>
							<h6 class="fs-17 font-weight-600 mb-0">Inventory List</h6>
						</div>
            @can('supplies-create')
            <div class="text-right">
              <a class="" href="{{ route('admin.supply.create') }}"><i class="far fa fa-plus"></i> Add Inventroy</a>
            </div>
            @endcan
					</div>
				</div>
  ...
  function getDateTime() {
    ...
    var table = $('table').DataTable({
      ...
      buttons: [
      {
          ...
          title: 'InventoryListReport-' + getDateTime(),
      ...
      ajax: {
          'url': '{!! route('admin.supply.ajax_data') !!}',
          // 'data': function (d) {
